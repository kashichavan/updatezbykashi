...
for i in range(1, 101):
    ...
    elif i <= 70: run_js(f"JS{i:03d} Function test {i}", f"function f(n) {{ return n * 2; }}\nlet r = f({i});\nconsole.log(r);", f"[JS] {i*2}")
