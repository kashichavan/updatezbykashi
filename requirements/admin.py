...
class JobPostingAdmin(admin.ModelAdmin):
    list_display = ('title', 'company_name', 'job_type', 'stipend_salary', 'location', 'deadline', 'status', 'applications_count', 'is_featured')
    list_filter = ('job_type', 'status', 'is_remote', 'category', 'is_featured')
