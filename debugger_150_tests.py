...
run_js("J05 Array push", "let items = [1, 2];\nitems.push(3);\nconsole.log(items.join(', '));", expect_stdout="1, 2, 3")
...
run_js("J45 Array of names push", "let names = ['Alice', 'Bob'];\nnames.push('Kashi');\nconsole.log('Members: ' + names.join(', '));", expect_stdout="Alice, Bob, Kashi")
